...
Achievements.Add("50_kills", "I bet they were all no-scopes.", "Get 50 kills.", function(ply)
	...
	if tonumber(check) == 0 and tonumber(kills) >= 50 then
		...
		Achievements.MessageLocal(ply, "Achievement unlocked: I bet they were all no-scopes.")
		Achievements.MessageGlobal(ply, ply:Name() .. " unlocked: I bet they were all no-scopes.")
	end

end)

Achievements.Add("100_kills", "Sorry KennyS, don't hurt me.", "Get 100 kills.", function(ply)
	...
	if tonumber(check) == 0 and tonumber(kills) >= 100 then
		...
		Achievements.MessageLocal(ply, "Achievement unlocked: Sorry KennyS, don't hurt me.")
		Achievements.MessageGlobal(ply, ply:Name() .. " unlocked: Sorry KennyS, don't hurt me.")
	end

end)

Achievements.Add("1000_kills", "I bet you feel cool.", "Get 1000 kills.", function(ply)
	...
	if tonumber(check) == 0 and tonumber(kills) >= 1000 then
		...
		Achievements.MessageLocal(ply, "Achievement unlocked: I bet you feel cool.")
		Achievements.MessageGlobal(ply, ply:Name() .. " unlocked: I bet you feel cool.")
	end
